    ...
    def handle(self, *args, **kwargs):
        ...
        for days_ahead in range(30):
            ...
            try:
                ...
                if not events:
                    self.stdout.write(f'  No games found for this date')
                    continue
                ...
                for event in events:
                    try:
                        ...
                        if created:
                            games_created += 1
                            self.stdout.write(f'  Created: {visitor_team.abbreviation} @ {home_team.abbreviation} ({game_status})')
                        else:
                            games_updated += 1
                            self.stdout.write(f'  Updated: {visitor_team.abbreviation} @ {home_team.abbreviation} ({game_status})')
